...
(
    ...
    OLD_PREFECTURE_NAME               VARCHAR(60) NOT NULL,
    NEW_PREFECTURE_NAME               VARCHAR(60) NOT NULL,
...
(
    PREFECTURE_ID_FROM              VARCHAR(60) NOT NULL,
    PREFECTURE_ID_TO                VARCHAR(60) NOT NULL,
